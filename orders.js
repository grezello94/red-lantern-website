    ...
    if (assignmentMode === 'edit') {
      ...
      if (grid && anchor) {
        ...
        if (printer.type === 'bill') {
          ...
          preview.innerHTML = `<div><b>Live bill preview</b><p>This is a scaled 80 mm receipt preview. Change any active setting to see its spacing, width and text hierarchy before printing.</p></div><div class="receipt-preview-paper" data-receipt-preview-paper><div class="rp-center rp-name" data-rp-name>Red Lantern Restaurant</div><div class="rp-center" data-rp-header>Colva Goa<br>9922853605 / 9049558369<br>[Follow] Insta ID:<br>red_lantern_restaurant</div><div class="rp-rule"></div><div data-rp-date>Date: 16/08/26 09:59 &nbsp;&nbsp; Dine In · AC</div><div class="rp-meta"><span>Cashier: biller</span><span>Bill No.: 05</span></div><b>Token No.: 01</b><div class="rp-rule"></div><div class="rp-table rp-head"><span>Item</span><span>Qty</span><span>Price</span><span>Amount</span></div><div class="rp-rule"></div><div class="rp-table"><span>Tomato Salad<br>(Regular)</span><span>1</span><span>120.00</span><span>120.00</span></div><div class="rp-table"><span>Veg Sweet Corn<br>Soup (Regular)</span><span>1</span><span>120.00</span><span>120.00</span></div><div class="rp-rule"></div><div data-rp-summary>Total Qty: 2 &nbsp;&nbsp; Sub Total: ₹240</div><div class="rp-grand" data-rp-grand>GRAND TOTAL: ₹240</div><div class="rp-rule"></div><div class="rp-foot" data-rp-footer>Thank you for choosing us!<br>Kindly leave us a review<br>Google | Zomato | Swiggy</div></div>`;
